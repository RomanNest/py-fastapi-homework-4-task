...
from database import (
    get_db, UserGroupModel, UserModel, UserProfileModel, UserGroupEnum,
)
...
async def create_profile(
        user_id: int,
        request: ProfileRequestSchema = Depends(
            ProfileRequestSchema.from_form
        ),
    ...
    avatar_bytes = await request.avatar.read()
    avatar_key = f"avatars/{user_id}_{request.avatar.filename}"
